...
class MediaCache(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    # ссылка на видео Facebook
    media_url: Mapped[str] = mapped_column(String(500), index=True)
    # формат скачивания: video_hd, video_sd, audio
    ...
    def __repr__(self) -> str:
        return f"<MediaCache {self.media_url[:30]}... ({self.media_type})>"
