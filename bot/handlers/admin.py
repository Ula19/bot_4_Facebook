...
async def admin_cookies_info(callback: CallbackQuery) -> None:
    ...
    from bot.services.facebook import downloader
    status = t("admin.cookies_active" if downloader.has_cookies() else "admin.cookies_missing", lang)
